const artworks = [
  {id:"veiled-queen", title:"Royal Rest", medium:"Oil on canvas", size:"72 × 60 cm", year:"2026", price:"¥180,000", image:"images/veiled-queen.svg", available:true},
  {id:"quiet-field", title:"Quiet Field", medium:"Acrylic on linen", size:"70 × 50 cm", year:"2026", price:"¥145,000", image:"images/quiet-field.svg", available:true},
  {id:"after-rain", title:"After Rain", medium:"Oil & pigment", size:"90 × 65 cm", year:"2025", price:"¥220,000", image:"images/after-rain.svg", available:true},
  {id:"soft-distance", title:"Soft Distance", medium:"Oil on linen", size:"60 × 45 cm", year:"2025", price:"¥125,000", image:"images/soft-distance.svg", available:true},
  {id:"first-light", title:"First Light", medium:"Acrylic & charcoal", size:"50 × 40 cm", year:"2025", price:"¥95,000", image:"images/first-light.svg", available:false},
